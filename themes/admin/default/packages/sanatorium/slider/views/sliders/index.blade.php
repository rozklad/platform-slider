...
@section('title')
@parent
{{ trans('sanatorium/slider::sliders/common.title') }}
@stop
...
{{ Asset::queue('index', 'sanatorium/slider::sliders/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<span class="navbar-brand">{{{ trans('sanatorium/slider::sliders/common.title') }}}</span>
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.sanatorium.slider.sliders.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="slider" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="slider" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="slider" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
							...
							<span class="input-group-btn">
								...
								<button class="btn btn-default" data-grid="slider" data-reset>
	...
	<div class="panel-body">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
			...
			<div id="data-grid_applied" class="btn-group" data-grid="slider"></div>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.sanatorium.slider.sliders.grid') }}" data-grid="slider">
			<thead>
				<tr>
	...
	<footer class="panel-footer clearfix">
		...
		{{-- Grid: Pagination --}}
		<div id="data-grid_pagination" data-grid="slider"></div>

	</footer>

	{{-- Grid: templates --}}
	@include('sanatorium/slider::sliders/grid/index/results')
	@include('sanatorium/slider::sliders/grid/index/pagination')
	@include('sanatorium/slider::sliders/grid/index/filters')
	@include('sanatorium/slider::sliders/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('sanatorium/slider::sliders/help')
@endif
